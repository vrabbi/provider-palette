...
func (tr *AzureCluster) GetObservation() (map[string]any, error) {
...
func (tr *AzureCluster) SetObservation(obs map[string]any) error {
...
func (tr *AzureCluster) GetParameters() (map[string]any, error) {
...
func (tr *AzureCluster) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AzureCluster
func (tr *AzureCluster) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AzureCluster
func (tr *AzureCluster) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
