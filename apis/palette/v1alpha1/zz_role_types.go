...
type RoleInitParameters struct {
	...
	// (String) The role type. Allowed values are project or tenant or resource
...
// Role is the Schema for the Roles API. The role resource allows you to manage roles in Palette.
