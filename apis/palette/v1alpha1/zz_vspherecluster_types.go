...
type VSphereClusterClusterProfileObservation struct {
...
type VSphereClusterParameters struct {
	...
	// +kubebuilder:validation:Optional
	ClusterProfile []VSphereClusterClusterProfileParameters `json:"clusterProfile,omitempty" tf:"cluster_profile,omitempty"`
...
type VSphereClusterSpec struct {
	...
	ForProvider     VSphereClusterParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VSphereClusterInitParameters `json:"initProvider,omitempty"`
}

// VSphereClusterStatus defines the observed state of VSphereCluster.
type VSphereClusterStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VSphereClusterObservation `json:"atProvider,omitempty"`
}
...
// VSphereCluster is the Schema for the VSphereClusters API. <no value>
...
// VSphereClusterList contains a list of VSphereClusters
...
var (
	VSphereCluster_Kind             = "VSphereCluster"
	VSphereCluster_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VSphereCluster_Kind}.String()
	VSphereCluster_KindAPIVersion   = VSphereCluster_Kind + "." + CRDGroupVersion.String()
	VSphereCluster_GroupVersionKind = CRDGroupVersion.WithKind(VSphereCluster_Kind)
)
