...
type BackupStorageLocationInitParameters struct {
...
type BackupStorageLocationObservation struct {
...
type BackupStorageLocationParameters struct {
...
type BackupStorageLocationSpec struct {
	...
	ForProvider     BackupStorageLocationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider BackupStorageLocationInitParameters `json:"initProvider,omitempty"`
}
...
type BackupStorageLocationStatus struct {
	...
	AtProvider        BackupStorageLocationObservation `json:"atProvider,omitempty"`
}
...
// BackupStorageLocationList contains a list of BackupStorageLocations
...
var (
	BackupStorageLocation_Kind             = "BackupStorageLocation"
	BackupStorageLocation_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BackupStorageLocation_Kind}.String()
	BackupStorageLocation_KindAPIVersion   = BackupStorageLocation_Kind + "." + CRDGroupVersion.String()
	BackupStorageLocation_GroupVersionKind = CRDGroupVersion.WithKind(BackupStorageLocation_Kind)
)
