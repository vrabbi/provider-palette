...
type ProjectRoleInitParameters struct {
	...
	// Reference to a Project in palette to populate projectId.
	// +kubebuilder:validation:Optional
	ProjectIDRef *v1.Reference `json:"projectIdRef,omitempty" tf:"-"`

	// Selector for a Project in palette to populate projectId.
	// +kubebuilder:validation:Optional
	...
	// References to Role in palette to populate roleIds.
	// +kubebuilder:validation:Optional
	RoleIdsRefs []v1.Reference `json:"roleIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Role in palette to populate roleIds.
	// +kubebuilder:validation:Optional
...
type ResourceRoleInitParameters struct {
	...
	// List of filter ids.
	// +crossplane:generate:reference:type=github.com/vrabbi/provider-palette/apis/palette/v1alpha1.Filter
	// +listType=set
	FilterIds []*string `json:"filterIds,omitempty" tf:"filter_ids,omitempty"`

	// References to Filter in palette to populate filterIds.
	// +kubebuilder:validation:Optional
	FilterIdsRefs []v1.Reference `json:"filterIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Filter in palette to populate filterIds.
	// +kubebuilder:validation:Optional
	...
	// References to Project in palette to populate projectIds.
	// +kubebuilder:validation:Optional
	ProjectIdsRefs []v1.Reference `json:"projectIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Project in palette to populate projectIds.
	// +kubebuilder:validation:Optional
...
type UserInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/vrabbi/provider-palette/apis/palette/v1alpha1.Team
	TeamIds []*string `json:"teamIds,omitempty" tf:"team_ids,omitempty"`

	// References to Team in palette to populate teamIds.
	// +kubebuilder:validation:Optional
	TeamIdsRefs []v1.Reference `json:"teamIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Team in palette to populate teamIds.
	// +kubebuilder:validation:Optional
	...
	// References to Role in palette to populate tenantRole.
	// +kubebuilder:validation:Optional
	TenantRoleRefs []v1.Reference `json:"tenantRoleRefs,omitempty" tf:"-"`

	// Selector for a list of Role in palette to populate tenantRole.
	// +kubebuilder:validation:Optional
