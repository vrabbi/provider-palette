...
type PlatformSettingInitParameters struct {
...
type PlatformSettingObservation struct {
...
type PlatformSettingParameters struct {
...
// PlatformSettingSpec defines the desired state of PlatformSetting
type PlatformSettingSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     PlatformSettingParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider PlatformSettingInitParameters `json:"initProvider,omitempty"`
}

// PlatformSettingStatus defines the observed state of PlatformSetting.
type PlatformSettingStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        PlatformSettingObservation `json:"atProvider,omitempty"`
}
...
// PlatformSetting is the Schema for the PlatformSettings API.
...
type PlatformSetting struct {
	...
	Spec              PlatformSettingSpec   `json:"spec"`
	Status            PlatformSettingStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// PlatformSettingList contains a list of PlatformSettings
...
var (
	PlatformSetting_Kind             = "PlatformSetting"
	PlatformSetting_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: PlatformSetting_Kind}.String()
	PlatformSetting_KindAPIVersion   = PlatformSetting_Kind + "." + CRDGroupVersion.String()
	PlatformSetting_GroupVersionKind = CRDGroupVersion.WithKind(PlatformSetting_Kind)
)

func init() {
	SchemeBuilder.Register(&PlatformSetting{}, &PlatformSettingList{})
}
