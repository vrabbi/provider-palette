...
// GetInitParameters of this ClusterGroup
func (tr *ClusterGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ClusterGroup
func (tr *ClusterGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
