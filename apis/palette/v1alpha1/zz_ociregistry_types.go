...
type OCIRegistryCredentialsInitParameters struct {
...
type OCIRegistryCredentialsObservation struct {
...
type OCIRegistryCredentialsParameters struct {
...
type OCIRegistryInitParameters struct {
	...
	Credentials []OCIRegistryCredentialsInitParameters `json:"credentials,omitempty" tf:"credentials,omitempty"`
...
type OCIRegistryObservation struct {
	...
	// (Block List, Min: 1, Max: 1) Authentication credentials to access the private OCI registry. Required if is_private is set to true (see below for nested schema)
	// Authentication credentials to access the private OCI registry. Required if `is_private` is set to `true`
	Credentials []OCIRegistryCredentialsObservation `json:"credentials,omitempty" tf:"credentials,omitempty"`
...
type OCIRegistryParameters struct {
	...
	// Authentication credentials to access the private OCI registry. Required if `is_private` is set to `true`
	// +kubebuilder:validation:Optional
	Credentials []OCIRegistryCredentialsParameters `json:"credentials,omitempty" tf:"credentials,omitempty"`
...
// OCIRegistrySpec defines the desired state of OCIRegistry
type OCIRegistrySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OCIRegistryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OCIRegistryInitParameters `json:"initProvider,omitempty"`
}

// OCIRegistryStatus defines the observed state of OCIRegistry.
type OCIRegistryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OCIRegistryObservation `json:"atProvider,omitempty"`
}
...
// OCIRegistry is the Schema for the OCIRegistrys API.
...
type OCIRegistry struct {
	...
	Spec   OCIRegistrySpec   `json:"spec"`
	Status OCIRegistryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OCIRegistryList contains a list of OCIRegistrys
...
var (
	OCIRegistry_Kind             = "OCIRegistry"
	OCIRegistry_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OCIRegistry_Kind}.String()
	OCIRegistry_KindAPIVersion   = OCIRegistry_Kind + "." + CRDGroupVersion.String()
	OCIRegistry_GroupVersionKind = CRDGroupVersion.WithKind(OCIRegistry_Kind)
)
