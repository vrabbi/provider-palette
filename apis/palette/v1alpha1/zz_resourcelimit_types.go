...
// ResourceLimitSpec defines the desired state of ResourceLimit
type ResourceLimitSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ResourceLimitParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ResourceLimitInitParameters `json:"initProvider,omitempty"`
}

// ResourceLimitStatus defines the observed state of ResourceLimit.
type ResourceLimitStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ResourceLimitObservation `json:"atProvider,omitempty"`
}
...
// ResourceLimit is the Schema for the ResourceLimits API.
...
type ResourceLimit struct {
	...
	Spec              ResourceLimitSpec   `json:"spec"`
	Status            ResourceLimitStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ResourceLimitList contains a list of ResourceLimits
type ResourceLimitList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ResourceLimit `json:"items"`
}

// Repository type metadata.
var (
	ResourceLimit_Kind             = "ResourceLimit"
	ResourceLimit_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ResourceLimit_Kind}.String()
	ResourceLimit_KindAPIVersion   = ResourceLimit_Kind + "." + CRDGroupVersion.String()
	ResourceLimit_GroupVersionKind = CRDGroupVersion.WithKind(ResourceLimit_Kind)
)

func init() {
	SchemeBuilder.Register(&ResourceLimit{}, &ResourceLimitList{})
}
